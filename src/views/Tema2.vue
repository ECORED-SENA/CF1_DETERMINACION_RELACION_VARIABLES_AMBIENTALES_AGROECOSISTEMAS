            ...
            SlyderA(tipo="b")
              .row.align-items-center.p-4.justify-content-center
                .col-lg-6.mb-4.mb-md-0
                  ...
                  p Se caracteriza por el desarrollo de cultivos en grandes áreas para la producción de una sola especie de planta, en estos agroecosistemas se puede tener cierta facilitad para su manejo, pero a la vez puede también acrecentar el ataque de plagas y enfermedades.
              ...
              .row.align-items-center.p-4.justify-content-center
                .col-lg-6.mb-4.mb-md-0
                  ...
                  p se componen por la integración entre de especies forestales árboles y cultivos agrícolas en una misma área, lo que permite generar un mayor equilibrio entre el cultivo y la flora y la fauna, además, contribuye con la gestión adecuada del agua y la conservación del suelo.
